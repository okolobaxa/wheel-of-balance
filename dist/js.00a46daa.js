...
var Wheel = /*#__PURE__*/function () {
  ...
  _createClass(Wheel, [{
    ...
    value: function onmove(e) {
      var _this$calculateLineEn2 = this.calculateLineEnd(canvas, e),
          dx = _this$calculateLineEn2.dx,
          dy = _this$calculateLineEn2.dy;

      var cursorPointRadius = Math.sqrt(dx * dx + dy * dy);
